...
export default function Resume() {
  return (
    <section id="resume" className="max-w-5xl mx-auto py-16 px-6 animate-fade-in">
      <h2 className="text-3xl font-bold mb-4 text-primary">Resume</h2>
      <div className="bg-white rounded-lg shadow-md border p-6 flex flex-col items-center">
        <p className="text-gray-700 mb-4 text-center">Download my latest resume to learn more about my experience, skills, and projects.</p>
        <a
          href="/resume.pdf"
          download
        ...
        <span className="text-xs text-gray-400 mt-2">(Add your PDF as <code>public/resume.pdf</code>)</span>
      </div>
    </section>
  );
}
